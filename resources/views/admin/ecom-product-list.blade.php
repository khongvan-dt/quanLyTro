...
<!-- Mirrored from yashadmin.w3itexpert.com/laravel/demo/ecom-product-list by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Oct 2023 17:55:03 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>YashAdmin Laravel | Product List</title>
    ...
    <meta property="og:description" content="YashAdmin Laravel | Product List">
...
<body>
    ...
    ********************-->
    <div id="preloader">
        <div>
            <img src="public/images/pre.gif" alt="">
        </div>
    </div>
    <!--*******************
        Preloader end
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" style="">
                                            <div class="card border-0 mb-0">
                                                <div class="card-header py-2">
                                                    <div class="products">
                                                        <img src="public/images/user.jpg" class="avatar avatar-md"
                                                            alt="">
                                                        <div>
...
<!-- Mirrored from yashadmin.w3itexpert.com/laravel/demo/ecom-product-list by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Oct 2023 17:55:05 GMT -->
